...
export default  function Main(){
    ...
    <div className="person">
        <h2>Hello,<br/>I'm Muhammad Sheikh alard<br/><span>Web Developer & Computer Engr.</span></h2>
        <h3>I develop websites depending <br/>on the top standards.</h3>
        <a href="#projects" className="main-btn"  id="btn">View my work</a>
        <a href="#contact" className="sec-btn">Let's work together</a>
