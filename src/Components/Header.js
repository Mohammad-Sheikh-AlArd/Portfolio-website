...
function toggleMode() {
  ...
  document.querySelector(".sec-btn").classList.toggle("d-sec-btn");
...
window.onscroll = function () {
  ...
  if (top >= 100) {
    if (dark) {
      document.querySelector(".header").classList.add("d-active");
    } else {
      document.querySelector(".header").classList.add("active");
    }
  } else {
    if (dark) {
      document.querySelector(".header").classList.remove("d-active");
    } else {
  ...
  return (
    <header className="header">
      ...
      <div className="navmoon">
        ...
        <div style={{ width: "2em", marginLeft: "1.5em" }} onClick={toggleMode}>
          <i className="fa-solid fa-moon" id="modeBtn"></i>
        </div>
      </div>
    </header>
  );
