...
function App() {
  ...
  for (let i = 0; i < ProjCards.length; i++) {
      ...
      ProjCardsDataShow[i]=<ProjCard key={i}
      img={ProjCards[i].img} 
  ...
  return (
    <div className="App">
      <Header/>
        ...
        <Section title="Projects" id="projects" bgColor="var(--color-yello)" containt={ProjCardsDataShow}/>
        <Section title="Let's work together" id="contact" containt={ContCardsDataShow}/>
      <Footer/>
    </div>
  );
}
